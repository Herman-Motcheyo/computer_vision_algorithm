...
int main(int argc, char* argv[])
    ...
    {
      printf("Nombre d'iterations ou k invalide\n");
      exit(1);
    }
    ...
    Kmeans(bitmap, clustermap, clusters, labels, cluster_count, largeur, hauteur, iterations);


    FILE* ifpWrite = fopen("../image/kmeans.ppm", "w");
